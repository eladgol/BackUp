...
::getStreamParameters(unsigned clientSessionId,
  ...
  isMulticast = False;
  envir() << "OnDemandServerMediaSubsession::startStream " << ((unsigned char*)&destinationAddr.s_addr)[0] << "." << ((unsigned char*)&destinationAddr.s_addr)[1] << "." << ((unsigned char*)&destinationAddr.s_addr)[2] << "." << ((unsigned char*)&destinationAddr.s_addr)[3] << "\n";
  envir() << "OnDemandServerMediaSubsession::startStream rtp port " << serverRTPPort.num() << " rtcp port " << serverRTCPPort.num() << "\n";
...
void OnDemandServerMediaSubsession::startStream(unsigned clientSessionId,
  ...
  if (streamState != NULL) {
	  envir() << "OnDemandServerMediaSubsession::startStream " << ((unsigned char*)&destinations->addr.s_addr)[0] << "." << ((unsigned char*)&destinations->addr.s_addr)[1] << "." << ((unsigned char*)&destinations->addr.s_addr)[2] << "." << ((unsigned char*)&destinations->addr.s_addr)[3] << "\n";
	  envir() << "OnDemandServerMediaSubsession::startStream rtp port " << destinations->rtpPort << " rtcp port " << destinations->rtcpPort << "\n";
