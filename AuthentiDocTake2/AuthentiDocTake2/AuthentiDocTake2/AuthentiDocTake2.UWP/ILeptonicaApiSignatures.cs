...
namespace AuthentiDocTake2.WindowsShared
{
    ...
    public class ILeptonicaApiSignatures
    {
    	#region PixA
		...
		public static extern
        unsafe IntPtr pixClone(IntPtr pix);
		...
		public static extern
        int pixGetResolution(IntPtr pix, out int xres, out int yres);
		...
		public static extern
        int pixSetInputFormat(IntPtr pix, ImageFormat inputFormat);
		...
		public static extern
        int pixWrite(string filename, IntPtr handle, ImageFormat format);
		...
		public static extern
        int pixSetColormap(IntPtr pix, IntPtr pixCmap);
		...
		public static extern
        IntPtr pixConvertRGBToGray(IntPtr pix, float rwt, float gwt, float bwt);
		...
		public static extern
        IntPtr pixDeskewGeneral(IntPtr pix, int redSweep, float sweepRange, float sweepDelta, int redSearch, int thresh, out float pAngle, out float pConf);
		...
		public static extern
        IntPtr pixRotateOrth(IntPtr pixs, int quads);
		...
		public static extern
        int pixOtsuAdaptiveThreshold(IntPtr pix, int sx, int sy, int smoothx, int smoothy, float scorefract, out IntPtr ppixth, out IntPtr ppixd);


        [DllImport(Constants.LeptonicaDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixSauvolaBinarize")] 
		public static extern
        int pixSauvolaBinarize(IntPtr pix, int whsize, float factor, int addborder, out IntPtr ppixm, out IntPtr ppixsd, out IntPtr ppixth, out IntPtr ppixd);


        [DllImport(Constants.LeptonicaDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixSauvolaBinarizeTiled")] 
		public static extern
        int pixSauvolaBinarizeTiled(IntPtr pix, int whsize, float factor, int nx, int ny, out IntPtr ppixth, out IntPtr ppixd);

        // Scaling - src/scale.c

        [DllImport(Constants.LeptonicaDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixScale")] 
		public static extern
        IntPtr pixScale(IntPtr pixs, float scalex, float scaley);
		...
		public static extern
        int pixcmapGetMinDepth(IntPtr cmap, out int minDepth);
		...
		public static extern
        int pixcmapAddColor(IntPtr cmap, int redValue, int greenValue, int blueValue);
		...
		public static extern
        int pixcmapAddNewColor(IntPtr cmap, int redValue, int greenValue, int blueValue, out int colorIndex);
		...
		public static extern
        int pixcmapAddNearestColor(IntPtr cmap, int redValue, int greenValue, int blueValue, out int colorIndex);
		...
		public static extern
        int pixcmapUsableColor(IntPtr cmap, int redValue, int greenValue, int blueValue, out int usable);
		...
		public static extern
        int pixcmapAddBlackOrWhite(IntPtr cmap, int color, out int index);
		...
		public static extern
        int pixcmapSetBlackAndWhite(IntPtr cmap, int setBlack, int setWhite);
		...
		public static extern
        int pixcmapGetColor(IntPtr cmap, int index, out int redValue, out int blueValue, out int greenValue);
		...
		public static extern
        int pixcmapGetColor32(IntPtr cmap, int index, out int color);
		...
		public static extern
        int pixcmapResetColor(IntPtr cmap, int index, int redValue, int blueValue, int greenValue);
		...
		public static extern
        int pixcmapGetIndex(IntPtr cmap, int redValue, int blueValue, int greenValue, out int index);
		...
		public static extern
        int pixcmapHasColor(IntPtr cmap, int color);
		...
		public static extern
        int pixcmapCountGrayColors(IntPtr cmap, out int ngray);
        ...
        [DllImport(Constants.LeptonicaDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixcmapCountGrayColors")] 
		public static extern
        int pixcmapGetRankIntensity(IntPtr cmap, float rankVal, out int index);
		...
		public static extern
        int pixcmapGetNearestIndex(IntPtr cmap, int rVal, int bVal, int gVal, out int index);
		...
		public static extern
        int pixcmapGetNearestGrayIndex(IntPtr cmap, int val, out int index);

        [DllImport(Constants.LeptonicaDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixcmapGetComponentRange")] 
		public static extern
        int pixcmapGetComponentRange(IntPtr cmap, int component, out int minVal, out int maxVal);

        [DllImport(Constants.LeptonicaDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixcmapGetExtremeValue")] 
		public static extern
        int pixcmapGetExtremeValue(IntPtr cmap, int type, out int rVal, out int gVal, out int bVal);
		...
		public static extern
        IntPtr pixcmapColorToGray(IntPtr cmaps, float redWeight, float greenWeight, float blueWeight);

        // colormap serialization

        [DllImport(Constants.LeptonicaDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixcmapColorToGray")] 
		public static extern
        int pixcmapToArrays(IntPtr cmap, out IntPtr redMap, out IntPtr blueMap, out IntPtr greenMap);


        [DllImport(Constants.LeptonicaDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixcmapToRGBTable")] 
		public static extern
        int pixcmapToRGBTable(IntPtr cmap, out IntPtr colorTable, out int colorCount);


        [DllImport(Constants.LeptonicaDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixcmapSerializeToMemory")] 
		public static extern
        int pixcmapSerializeToMemory(IntPtr cmap, out int components, out int colorCount, out IntPtr colorData, out int colorDataLength);


        [DllImport(Constants.LeptonicaDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixcmapDeserializeFromMemory")] 
		public static extern
        IntPtr pixcmapDeserializeFromMemory(IntPtr colorData, int colorCount, int colorDataLength);
