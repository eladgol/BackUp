...
{		
    ...
    public interface ILeptonicaApiSignatures
    {
        ...
        int pixaGetCount( HandleRefCustom pixa );

        [RuntimeDllImport(Constants.LeptonicaDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixaGetPix")]
        IntPtr pixaGetPix( HandleRefCustom pixa, int index, PixArrayAccessType accesstype );
        ...
        unsafe IntPtr pixClone(HandleRefCustom pix);
        ...
        IntPtr pixDeskewGeneral(HandleRefCustom pix, int redSweep, float sweepRange, float sweepDelta, int redSearch, int thresh, out float pAngle, out float pConf);

        // rotation

        [RuntimeDllImport(Constants.LeptonicaDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixRotate")]
        IntPtr pixRotate(HandleRefCustom pixs, float angle, RotationMethod type, RotationFill fillColor, int width, int heigh);

        [RuntimeDllImport(Constants.LeptonicaDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixRotateOrth")]
        IntPtr pixRotateOrth(HandleRefCustom pixs, int quads);
        ...
        int pixOtsuAdaptiveThreshold(HandleRefCustom pix, int sx, int sy, int smoothx, int smoothy, float scorefract, out IntPtr ppixth, out IntPtr ppixd);


        [RuntimeDllImport(Constants.LeptonicaDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixSauvolaBinarize")]
        int pixSauvolaBinarize(HandleRefCustom pix, int whsize, float factor, int addborder, out IntPtr ppixm, out IntPtr ppixsd, out IntPtr ppixth, out IntPtr ppixd);


        [RuntimeDllImport(Constants.LeptonicaDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixSauvolaBinarizeTiled")]
        int pixSauvolaBinarizeTiled(HandleRefCustom pix, int whsize, float factor, int nx, int ny, out IntPtr ppixth, out IntPtr ppixd);

        // Scaling - src/scale.c

        [RuntimeDllImport(Constants.LeptonicaDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixScale")]
        IntPtr pixScale(HandleRefCustom pixs, float scalex, float scaley);
        ...
        IntPtr pixcmapCopy(HandleRefCustom cmaps);
        ...
        int pixcmapGetCount(HandleRefCustom cmap);
        ...
        int pixcmapGetFreeCount(HandleRefCustom cmap);
        ...
        int pixcmapGetDepth(HandleRefCustom cmap);
        ...
        int pixcmapGetMinDepth(HandleRefCustom cmap, out int minDepth);
        ...
        int pixcmapClear(HandleRefCustom cmap);
        ...
        int pixcmapAddColor(HandleRefCustom cmap, int redValue, int greenValue, int blueValue);
        ...
        int pixcmapAddNewColor(HandleRefCustom cmap, int redValue, int greenValue, int blueValue, out int colorIndex);
        ...
        int pixcmapAddNearestColor(HandleRefCustom cmap, int redValue, int greenValue, int blueValue, out int colorIndex);
        ...
        int pixcmapUsableColor(HandleRefCustom cmap, int redValue, int greenValue, int blueValue, out int usable);
        ...
        int pixcmapAddBlackOrWhite(HandleRefCustom cmap, int color, out int index);
        ...
        int pixcmapSetBlackAndWhite(HandleRefCustom cmap, int setBlack, int setWhite);
        ...
        int pixcmapGetColor(HandleRefCustom cmap, int index, out int redValue, out int blueValue, out int greenValue);
        ...
        int pixcmapGetColor32(HandleRefCustom cmap, int index, out int color);
        ...
        int pixcmapResetColor(HandleRefCustom cmap, int index, int redValue, int blueValue, int greenValue);
        ...
        int pixcmapGetIndex(HandleRefCustom cmap, int redValue, int blueValue, int greenValue, out int index);
        ...
        int pixcmapHasColor(HandleRefCustom cmap, int color);
        ...
        int pixcmapCountGrayColors(HandleRefCustom cmap, out int ngray);
        ...
        /// <returns>Returns 0 if OK; 1 on error.</returns>
        [RuntimeDllImport(Constants.LeptonicaDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixcmapCountGrayColors")]
        int pixcmapGetRankIntensity(HandleRefCustom cmap, float rankVal, out int index);
        ...
        int pixcmapGetNearestIndex(HandleRefCustom cmap, int rVal, int bVal, int gVal, out int index);
        ...
        int pixcmapGetNearestGrayIndex(HandleRefCustom cmap, int val, out int index);
        ...
        int pixcmapGetComponentRange(HandleRefCustom cmap, int component, out int minVal, out int maxVal);

        [RuntimeDllImport(Constants.LeptonicaDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixcmapGetExtremeValue")]
        int pixcmapGetExtremeValue(HandleRefCustom cmap, int type, out int rVal, out int gVal, out int bVal);
        ...
        IntPtr pixcmapColorToGray(HandleRefCustom cmaps, float redWeight, float greenWeight, float blueWeight);

        // colormap serialization

        [RuntimeDllImport(Constants.LeptonicaDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixcmapColorToGray")]
        int pixcmapToArrays(HandleRefCustom cmap, out IntPtr redMap, out IntPtr blueMap, out IntPtr greenMap);


        [RuntimeDllImport(Constants.LeptonicaDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixcmapToRGBTable")]
        int pixcmapToRGBTable(HandleRefCustom cmap, out IntPtr colorTable, out int colorCount);
        ...
        int pixcmapSerializeToMemory(HandleRefCustom cmap, out int components, out int colorCount, out IntPtr colorData, out int colorDataLength);
        ...
        IntPtr pixcmapDeserializeFromMemory(HandleRefCustom colorData, int colorCount, int colorDataLength);
